...
const translations = {
  ko: {
    ...
    "support.body": "연락은 이메일과 GitHub 프로필을 통해 받을 수 있고, 정책 문서는 이 페이지에서 한국어와 영어로 제공합니다.",
    "support.card1.label": "이메일 문의",
    "support.card1.meta": "직접 문의를 보낼 수 있는 기본 연락 채널입니다.",
    "support.card2.label": "GitHub 프로필",
    "support.card2.meta": "프로젝트 업데이트와 공개 저장소를 확인할 수 있는 연락 프로필입니다.",
    ...
    "privacy.section7.body":
      "본 정책에 대한 문의는 이메일 또는 GitHub 프로필을 통해 접수할 수 있습니다.",
    ...
    "terms.section7.body":
      "본 약관의 중요한 변경 사항은 이 페이지에 반영됩니다. 문의는 이메일 또는 GitHub 프로필을 통해 받을 수 있습니다.",
  ...
  en: {
    ...
    "support.body": "Contact details are provided through email and the GitHub profile, and the policy pages are available here in Korean and English.",
    "support.card1.label": "Email Contact",
    "support.card1.meta": "Primary direct contact channel for questions and support.",
    "support.card2.label": "GitHub Profile",
    "support.card2.meta": "Public profile for project updates and repository access.",
    ...
    "privacy.section7.body":
      "Questions about this policy may be submitted through email or the GitHub profile.",
    "terms.eyebrow": "TERMS OF USE",
    ...
    "terms.section7.body":
      "Material changes to these terms will be reflected on this page. Questions may be submitted through email or the GitHub profile.",
    "404.eyebrow": "NOT FOUND",
